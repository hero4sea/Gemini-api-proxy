...
<style>
    ...
    *, *:before, *:after {
    ...
    section[data-testid="stSidebar"] {
        ...
        position: relative;
        overflow: hidden;
        /* 移除强制控制：transform, position: fixed 等 */
    }
